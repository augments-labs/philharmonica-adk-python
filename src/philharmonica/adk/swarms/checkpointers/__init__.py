"""Concrete :class:`~philharmonica.adk.swarms.checkpointer.SwarmCheckpointer` implementations.
...
:class:`~philharmonica.adk.swarms.checkpointers.postgres.PostgresSwarmCheckpointer` —
...
:class:`~philharmonica.adk.swarms.checkpointers.redis.RedisSwarmCheckpointer` —
...
:class:`~philharmonica.adk.swarms.checkpointers.s3.S3SwarmCheckpointer` —
