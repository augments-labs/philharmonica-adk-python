...
if TYPE_CHECKING:
    from philharmonica.adk.types.output.llm_response_function_tool_call_param import (
        LLMResponseFunctionToolCallParam,
    )
    from philharmonica.adk.types.output.llm_response_provider_item_param import (
        LLMResponseProviderItemParam,
    )
    from philharmonica.adk.types.output.llm_response_reasoning_param import (
