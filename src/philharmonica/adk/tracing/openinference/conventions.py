...
def agent_attrs(data: AgentSpanData) -> dict[str, Any]:
    ...
    """
    attrs: dict[str, Any] = {SPAN_KIND: "AGENT", "philharmonica.agent.name": data.name}
...
def generation_attrs(data: GenerationSpanData) -> dict[str, Any]:
    ...
    """
    attrs: dict[str, Any] = {SPAN_KIND: "LLM", "llm.system": "philharmonica"}
...
def response_attrs(data: ResponseSpanData) -> dict[str, Any]:
    ...
    if data.response_id is not None:
        attrs["philharmonica.response.id"] = data.response_id
    return attrs
...
def custom_attrs_by_type(data: CustomSpanData) -> dict[str, Any]:
    ...
    attrs: dict[str, Any] = {SPAN_KIND: kind, "philharmonica.span.name": data.name}
    return attrs
