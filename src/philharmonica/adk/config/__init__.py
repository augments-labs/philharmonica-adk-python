"""Declarative agent configuration for the Philharmonica ADK.
...
from philharmonica.adk.config.hosted_tools import register_hosted_tool
from philharmonica.adk.config.loader import load_agent
from philharmonica.adk.config.providers import register_llm_provider
from philharmonica.adk.config.resolver import resolve_dotted_spec
from philharmonica.adk.config.topology import AgentTopology, build_topology, load_topology
