...
from philharmonica.adk.flows.registry import FlowStepRegistry, TriggerSpec

if TYPE_CHECKING:
    from philharmonica.adk.flows.deferred import FlowApprovalDecision
    from philharmonica.adk.flows.definition import FlowDefinition
    from philharmonica.adk.run.context import RunContext
    from philharmonica.adk.visualization.dot import DotRankdir
    from philharmonica.adk.visualization.mermaid import MermaidDirection
...
class Flow[StateT](metaclass=FlowMeta):
    ...
    Example::
        ...
        from philharmonica.adk.flows import Flow, flow_start, flow_listen, flow_router
    ...
    def to_mermaid(self, *, direction: MermaidDirection = "LR") -> str:
        ...
        """
        from philharmonica.adk.visualization.mermaid import flow_to_mermaid
    ...
    def to_dot(self, *, rankdir: DotRankdir = "LR") -> str:
        ...
        """
        from philharmonica.adk.visualization.dot import flow_to_dot
