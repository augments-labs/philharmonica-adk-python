...
from philharmonica.adk.run.cost import apply_result_limits, check_tool_call_limits_before_dispatch, minify_json
from philharmonica.adk.run.governance import emit_audit, emit_guardrail_audit, enforce_tenant_allowlist
...
_TOOL_STREAM_SINK: contextvars.ContextVar[ToolStreamSink | None] = contextvars.ContextVar(
    "philharmonica_tool_stream_sink",
    default=None,
)
...
def maybe_wrap_with_agent_middleware(
    ...
    from philharmonica.adk.tools.tool_middleware import (
...
async def execute_approved_tool(
    ...
    from philharmonica.adk.run.llm_calls import resolve_model_name
    from philharmonica.adk.tools.tool_context import ToolContext
    from philharmonica.adk.tools.tool_guardrails import ToolOutputGuardrailData
    ...
    from philharmonica.adk.run.llm_calls import resolve_function_tool
    ...
    if tool.history_aware:
        ...
        from philharmonica.adk.tools.tool_context import HistoryAwareToolContext
...
async def _execute_single_tool_call(
    ...
    from philharmonica.adk.types.tools.tool_output_types import ToolOutputFileContent, ToolOutputImage, ToolOutputText
    ...
    if (
        ...
        from philharmonica.adk.types.input.llm_input_image import LLMInputImage
...
async def execute_tool_calls_streamed(
    ...
    Returns:
        ...
        If deferred_requests is not None, execution was interrupted for approval.
    """
    from philharmonica.adk.run.stream import CancelMode, RunItemStreamEvent, RunItemType
    from philharmonica.adk.tools.deferred_tool import (
        DeferredToolCall,
        DeferredToolRequests,
    )
