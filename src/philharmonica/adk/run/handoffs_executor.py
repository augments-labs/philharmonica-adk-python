...
from philharmonica.adk.tracing import handoff_span
from philharmonica.adk.types.items import RunItem
from philharmonica.adk.types.items.items import ItemHelpers

if TYPE_CHECKING:
    from philharmonica.adk.agents.agent import Agent
    from philharmonica.adk.handoffs import Handoff, HandoffInputData, HandoffTarget
...
async def _summarize_for_handoff(
    ...
    """
    from philharmonica.adk.context.compaction import ContextCompactor
