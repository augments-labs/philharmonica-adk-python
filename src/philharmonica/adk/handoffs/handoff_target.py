...
from philharmonica.adk.utils import MaybeAwaitable

if TYPE_CHECKING:
    from philharmonica.adk.agents import Agent, BaseAgent
...
def _second_param_is_handoff_data(
    ...
    try:
        ...
        return raw is HandoffInputData or (
            ...
            in (
                "HandoffInputData",
                "philharmonica.adk.handoffs.handoff_input_data.HandoffInputData",
            )
        )
