...
> (see `src/philharmonica/adk/run/config.py`).
>
...
Until that ships, `src/philharmonica/adk/permissions/__init__.py` only re-exports these
...
CLAUDE.md under `src/philharmonica/adk/permissions/` for runner integration status.
