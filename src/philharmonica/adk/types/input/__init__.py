...
from philharmonica.adk.types.input.llm_input_audio import LLMInputAudio
...
from philharmonica.adk.types.input.llm_input_message import LLMInputContents, LLMInputMessage
