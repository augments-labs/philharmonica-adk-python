...
(``pip install 'philharmonica-adk[mcp,websockets]'``).
"""
...
from philharmonica.adk.mcp.exceptions import MCPConnectionError, UnsupportedTransportError
    ...
    async def connect(self) -> None:
        ...
        try:
            ...
            raise UnsupportedTransportError(
                ...
                "Install with: pip install 'philharmonica-adk[mcp]' websockets"
            ) from exc
