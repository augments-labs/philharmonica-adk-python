...
The reserved types in `src/philharmonica/adk/types/permissions/` model Anthropic's
...
See `src/philharmonica/adk/types/permissions/CLAUDE.md` for the reserved type catalog
