...
from philharmonica.adk.agents.agent_guardrails import AgentGuardrailResults
...
if TYPE_CHECKING:
    ...
    from philharmonica.adk.swarms.yield_signal import SwarmYieldSignal
...
def _make_default_context() -> Any:
    ...
    ``philharmonica.adk.run.context`` (which pulls in pieces of this module).
    """
    from philharmonica.adk.run.context import RunContext
...
class RunResult[T]:
    ...
    ``philharmonica.adk.run.swarm_loop``.
    """
