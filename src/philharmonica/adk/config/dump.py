...
_PROVIDER_CLASSES: tuple[tuple[str, str], ...] = (
    ("anthropic", "philharmonica.adk.llms.anthropic.anthropic_model:AnthropicLLM"),
    ("openai-responses", "philharmonica.adk.llms.openai.openai_responses_model:OpenAIResponsesLLM"),
    ("openai-chat", "philharmonica.adk.llms.openai.openai_chatcompletions_model:OpenAIChatCompletionsLLM"),
    ("gemini", "philharmonica.adk.llms.gemini.gemini_model:GeminiLLM"),
    ("litellm", "philharmonica.adk.llms.litellm.litellm_model:LiteLLM"),
)
