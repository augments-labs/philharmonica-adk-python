...
try:
    ...
    raise ImportError("ChromaVectorStore requires chromadb: pip install 'philharmonica-adk[memory-chroma]'") from exc
...
from philharmonica.adk.memory.vector_store import VectorQueryResult, VectorRecord
