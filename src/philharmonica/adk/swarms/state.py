...
from philharmonica.adk.graphs.interrupt import NESTED_AGENT_TOOL_APPROVAL_KIND, Interrupt, NestedAgentInterrupt
from philharmonica.adk.run.state import RunState
from philharmonica.adk.swarms.yield_signal import SwarmDone, SwarmHandoff, SwarmYieldSignal
...
class SwarmState[TContext]:
    ...
    ``philharmonica.swarm.id`` attribute appears on suspend-side and resume-side
    ...
    ``philharmonica.swarm.turn.resume_attempt``. Empty dict for fresh runs."""
