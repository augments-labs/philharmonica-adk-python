...
from philharmonica.adk.run.handoffs_executor import (
...
from philharmonica.adk.run.llm_calls import resolve_compaction_llm, resolve_model_name, resolve_output_schema
...
if TYPE_CHECKING:
    ...
    from philharmonica.adk.types.responses import LLMResponse
...
def resolve_swarm_yield_step(
    ...
    from philharmonica.adk.handoffs.handoff import HANDOFF_TOOL_PREFIX
    ...
    from philharmonica.adk.types.input import FunctionToolCallResultParam as _ToolResultParam
