...
from philharmonica.adk.handoffs import Handoff, HandoffRoute
from philharmonica.adk.llms import LLM, LLMConfig
from philharmonica.adk.prompts import DynamicSystemPrompt, SystemPrompt
...
from philharmonica.adk.tools import FunctionTool, FunctionToolset, Tool, Toolset
from philharmonica.adk.types.tools import ToolUseBehavior
from philharmonica.adk.utils import MaybeAwaitable, to_snake_case

logger = logging.getLogger(__name__)

if TYPE_CHECKING:
    from philharmonica.adk.hooks import AgentHooks, RunHooks
    from philharmonica.adk.llms.llm_usage import LLMUsageLimits
    from philharmonica.adk.run import RunConfig
    from philharmonica.adk.run.stream import StreamEvent
    ...
    from philharmonica.adk.types.agents.agent_as_tool_types import (
...
class BaseAgent(Generic[TContext]):
    ...
    Toolset example::
        ...
        from philharmonica.adk.tools import FunctionToolset
...
class Agent(BaseAgent, Generic[TContext]):
    ...
    Agents are the core building blocks of the Philharmonica framework. They combine:
    ...
    **LLM-orchestrated** (list): Agents exposed as transfer_to_<name> tools.
    ...
    Example::
        ...
        from philharmonica.adk.agents import Middleware
    ...
    def as_tool(
        ...
        *,
        ...
        from philharmonica.adk.schemas import SchemaEnforcement
        from philharmonica.adk.types.agents.agent_as_tool_types import AgentToolInput
        ...
        async def _on_invoke_tool(ctx: ToolContext, raw_input: str) -> str:
            ...
            try:
                ...
                from philharmonica.adk.exceptions import AgentToolDeferral, UserError
...
def _merge_budget(
    ...
    """
    from philharmonica.adk.run import RunConfig as _RunConfig
