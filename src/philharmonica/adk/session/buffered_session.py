...
``BufferedSession`` wraps any inner :class:`~philharmonica.adk.types.session.SessionStore`
and accumulates :class:`~philharmonica.adk.session.session_event.SessionEvent` objects in
...
class BufferedSession:
    """Write-coalescing wrapper around any :class:`~philharmonica.adk.types.session.SessionStore`.

    Accumulates :class:`~philharmonica.adk.session.session_event.SessionEvent` objects
    ...
    Attributes:
        _inner: The wrapped :class:`~philharmonica.adk.types.session.SessionStore`.
        ...
        *,
        ...
        Args:
            inner: Any object satisfying the
                :class:`~philharmonica.adk.types.session.SessionStore` protocol.
    ...
    async def get(self, limit: int | None = None) -> list[SessionEvent]:
        ...
        Returns:
            Combined list of :class:`~philharmonica.adk.session.session_event.SessionEvent`
    ...
    def pending_count(self) -> int:
        ...
        Returns:
            Count of unflushed :class:`~philharmonica.adk.session.session_event.SessionEvent`
            objects.
        """
