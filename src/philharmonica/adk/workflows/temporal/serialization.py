"""Temporal DataConverter factory for Philharmonica ADK.
...
from philharmonica.adk.schemas.agent_output_schema import AgentOutputSchemaBase

if TYPE_CHECKING:
    from temporalio.converter import DataConverter

    from philharmonica.adk.llms.llm_config import LLMConfig
    from philharmonica.adk.tools import FunctionTool, Tool
...
def tool_to_json_dict(tool: Tool) -> dict[str, Any] | None:
    ...
    """
    from philharmonica.adk.schemas.utils import SchemaEnforcement, normalize_schema
