...
composed inside ``call_llm_streamed`` in ``philharmonica.adk.run.llm_calls``.
...
if TYPE_CHECKING:
    ...
    from philharmonica.adk.llms.llm_middleware import LLMMiddleware, LLMMiddlewareNext
...
class LLMStreamMiddlewareTermination(PhilharmonicaError):
    ...
    *,
    ...
    Returns:
        ...
        Register each in its respective slot::
            ...
            from philharmonica.adk.llms.llm_stream_middleware import make_logging_middlewares
