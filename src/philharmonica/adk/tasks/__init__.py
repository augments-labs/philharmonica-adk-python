...
Canonical minimal example — two tasks in a sequential pipeline::
    ...
    from philharmonica.adk import Agent, Runner, Task, TaskPipeline
...
from philharmonica.adk.tasks.task import Task, TaskDependency, TaskInputFilter
from philharmonica.adk.tasks.task_group import ErrorPolicy, TaskGroup, TaskGroupResult
