...
Mirrors ``philharmonica.adk.handoffs.handoff_prompt.prompt_with_handoff_instructions``:
...
implicitly; Philharmonica does not. The helper exists so a developer who
