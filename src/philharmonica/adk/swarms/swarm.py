...
which delegates to the swarm driver in ``philharmonica.adk.run.swarm_loop`` —
...
from philharmonica.adk.swarms.policy import LLMHandoffPolicy, SwarmPolicy
...
class Swarm[TContext]:
    ...
    def __init__(
        ...
        *,
        ...
        policy: SwarmPolicy[TContext] | _Unset | None = _UNSET,
        termination: TerminationCondition | _Unset | None = _UNSET,
        config: SwarmConfig | _Unset | None = _UNSET,
        hooks: SwarmHooks[TContext] | None = None,
        name: str | None = None,
        description: str | None = None,
