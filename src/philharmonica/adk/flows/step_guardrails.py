...
Step-level analogue of :class:`philharmonica.adk.tools.tool_guardrails.ToolGuardrails`
...
class FlowStepGuardrailVerdict:
    ...
    :class:`philharmonica.adk.tools.tool_guardrails.ToolGuardrailFunctionOutput`:
...
class FlowStepGuardrails:
    ...
    :class:`philharmonica.adk.tools.tool_guardrails.ToolGuardrails`. Pre runs after
