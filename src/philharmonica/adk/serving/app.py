...
from philharmonica.adk.serving.health import ReadinessProbe, health_routes
from philharmonica.adk.serving.rest import SessionFactory, rest_routes
...
def _a2a_routes(a2a_server: A2AServer) -> list[BaseRoute]:
    ...
    """
    from philharmonica.adk.a2a import build_starlette_app
