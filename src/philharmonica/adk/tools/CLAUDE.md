...
family from `philharmonica.adk.memory`; `DocumentSearchTool` family (RAG search
over a document corpus) built on `philharmonica.adk.rag` — `document_search_tool.py`
