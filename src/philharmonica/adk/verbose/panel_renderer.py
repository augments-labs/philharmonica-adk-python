...
from philharmonica.adk.verbose.renderer import redact_secrets
from philharmonica.adk.verbose.state import BlockKey, BlockNode, RunTree
...
def format_tool_payload(tool_input: Any, tool_output: Any = None) -> str:
    ...
    """
    from philharmonica.adk.verbose.renderer import format_payload
