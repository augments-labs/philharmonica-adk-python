...
from philharmonica.adk.swarms.yield_signal import SWARM_DONE_TOOL_NAME, SwarmYieldSignal
...
# ---------------------------------------------------------------------------
# StructuredRoutingPolicy — the Philharmonica differentiator
# ---------------------------------------------------------------------------
...
class StructuredRoutingPolicy(SwarmPolicy[TContext]):
    ...
    This is the Philharmonica differentiator: full type safety, no routing
    ...
    routing; Philharmonica's Swarm lets structured output do the dispatch.
