...
from philharmonica.adk.exceptions.exceptions import PhilharmonicaError, UserError
...
class FlowStepDeferred(PhilharmonicaError):
...
class FlowStepGovernanceError(PhilharmonicaError):
...
class FlowStepSkipped(PhilharmonicaError):
...
class FlowStepRejected(PhilharmonicaError):
