...
if TYPE_CHECKING:
    ...
    from philharmonica.adk.flows.step_cache_policy import FlowStepCachePolicy
    from philharmonica.adk.flows.step_context import FlowStepGate
    from philharmonica.adk.flows.step_guardrails import FlowStepGuardrails
    from philharmonica.adk.flows.step_rate_limit import FlowStepRateLimit
...
def _normalize_trigger(trigger: FlowTriggerSpec) -> str | Or | And:
    ...
    if isinstance(trigger, (Or, And)):
        return trigger
    from philharmonica.adk.flows.flow_wrappers import name_of
