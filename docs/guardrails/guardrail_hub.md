...
- [Agent guardrails](agent_guardrails.md) — TRANSFORM action, severity, timeout,
  and the full agent-level guardrail reference.
- [Guardrails guide](../guides/guardrails.md) — getting-started guide and comparison with
  tool-level guardrails.
- [`Agent` API reference](../references/api/agent.md) — the public surface carrying `AgentInputGuardrail` and
