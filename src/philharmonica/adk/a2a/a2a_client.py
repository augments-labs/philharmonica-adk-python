...
try:
    ...
    if ie.name is not None and ie.name != "a2a" and not ie.name.startswith("a2a."):
        ...
        raise
    raise ImportError(
        "Please install the 'a2a' extra to use A2A protocol support. Run: pip install 'philharmonica-adk[a2a]'",
...
from philharmonica.adk.a2a.a2a_continuation_token import A2AContinuationToken, A2ATaskStatus
from philharmonica.adk.a2a.converters import stream_response_to_event
from philharmonica.adk.a2a.exceptions import (
    A2AProtocolError,
...
if TYPE_CHECKING:
    ...
    from philharmonica.adk.a2a.a2a_agent import A2ARunResult, A2AStreamEvent
        ...
        *,
        ...
        Raises:
            ...
            A2AProtocolError: Protocol-level failure from the remote
                endpoint.
        """
        from philharmonica.adk.a2a.a2a_agent import A2ARunResult  # avoid cycle
