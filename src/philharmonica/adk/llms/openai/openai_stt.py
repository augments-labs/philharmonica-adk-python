...
from philharmonica.adk.voice.audio import DEFAULT_SAMPLE_RATE
from philharmonica.adk.voice.exceptions import STTError, STTWebsocketError
from philharmonica.adk.voice.stt import StreamedTranscriptionSession, STTModel

if TYPE_CHECKING:
    from openai import AsyncOpenAI

    from philharmonica.adk.voice.audio import AudioInput, StreamedAudioInput
    from philharmonica.adk.voice.stt import STTModelSettings
        ...
        if client is None:
            try:
                ...
                raise ImportError(
                    ...
                    "Install it with: pip install 'philharmonica-adk[voice]'"
                ) from exc
    ...
    async def _connect(self) -> Any:
        ...
        try:
            ...
            raise STTWebsocketError(
                "Realtime speech-to-text requires 'websockets'. Install it with: pip install 'philharmonica-adk[voice]'"
            ) from exc
