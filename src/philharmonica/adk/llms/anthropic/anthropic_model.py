...
from philharmonica.adk.llms.anthropic.anthropic_boundary import (
    headers_as_sdk,
    metadata_as_sdk,
    sanitize_for_log,
)
...
from philharmonica.adk.llms.anthropic.anthropic_retry import call_with_retry
...
if TYPE_CHECKING:
    ...
    from philharmonica.adk.types.llms import EffortLevel
...
class AnthropicLLM(LLM):
    ...
    def _build_streaming_usage(
        *,
        ...
        merges both halves.
        """
        from philharmonica.adk.types.tokens import (
            InputTokensDetails,
