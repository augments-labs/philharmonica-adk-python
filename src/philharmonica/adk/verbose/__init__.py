...
from philharmonica.adk.verbose.panel_renderer import PanelRenderer, StreamCallType
from philharmonica.adk.verbose.renderer import VerboseRenderer, format_payload
...
__all__ = [
    ...
    "EVENT_HITL_APPROVAL_GRANTED",
    "EVENT_HITL_APPROVAL_REJECTED",
    # Reserved events — Philharmonica ADK enrichment beyond CrewAI
    "EVENT_HITL_APPROVAL_REQUESTED",
    "EVENT_KNOWLEDGE_QUERY",
    "EVENT_KNOWLEDGE_RESULT",
    "EVENT_LLM_END",
