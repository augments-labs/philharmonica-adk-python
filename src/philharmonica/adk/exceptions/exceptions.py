...
if TYPE_CHECKING:
    ...
    from philharmonica.adk.status.types import AgentQuota
    from philharmonica.adk.tools.deferred_tool import DeferredToolRequests


class PhilharmonicaError(Exception):
    """Base exception for all Philharmonica ADK errors."""
    ...
    def __init__(self, message: str | None = None):
        ...
        """
        self.message = message or "An error occurred in the Philharmonica ADK."
...
class UserError(PhilharmonicaError):
    """
...
class MemoryExtractionError(PhilharmonicaError):
...
class GuardrailTripwireTriggered(PhilharmonicaError):
...
class ToolGuardrailTripwireTriggered(PhilharmonicaError):
    """
...
class MaxTurnsExceeded(PhilharmonicaError):
    """
...
class UsageLimitExceeded(PhilharmonicaError):
    """
...
class ToolTimeoutError(PhilharmonicaError):
...
class ToolRetry(PhilharmonicaError):
...
class AgentToolDeferral(PhilharmonicaError):
...
class HandoffRejection(PhilharmonicaError):
...
class ToolDependencyError(PhilharmonicaError):
...
class DocumentLoadError(PhilharmonicaError):
...
class UnsupportedDocumentSourceError(PhilharmonicaError):
...
class ToolsetNameConflictError(PhilharmonicaError):
    ...
    def __init__(self, missing: str, message: str | None = None) -> None:
        ...
        super().__init__(
            ...
            or (
                ...
                "Install the optional extra: pip install 'philharmonica-adk[otel]'"
            )
        )
...
class TenantBudgetExceeded(PhilharmonicaError):
...
class ToolNotPermittedForTenant(PhilharmonicaError):
...
class NoRoutingCandidateError(PhilharmonicaError):
    """Raised when every routing candidate failed (or the list was empty)."""


class ModelRefusalError(PhilharmonicaError):
...
class SandboxError(PhilharmonicaError):
...
class CheckpointConflictError(PhilharmonicaError):
...
class SessionAppendConflictError(PhilharmonicaError):
