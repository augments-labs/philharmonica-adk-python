...
from philharmonica.adk.sandbox.clients.base import BaseSandboxClient, BaseSandboxClientOptions
...
def _require_httpx() -> None:
    try:
        ...
        raise UnsupportedSandboxClientError(
            ...
            "'httpx' package: pip install 'philharmonica-adk[sandbox-remote-vm]'",
        ) from exc
