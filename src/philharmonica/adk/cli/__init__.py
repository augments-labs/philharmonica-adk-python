"""Command-line interface for the Philharmonica ADK.

The ``philharmonica`` console script (also runnable as ``python -m
philharmonica.adk.cli``) drives agents built with this ADK from the terminal:
...
from philharmonica.adk import __version__, setup_logging


@click.group(name="philharmonica")
@click.version_option(version=__version__, prog_name="philharmonica")
def main() -> None:
    """Philharmonica ADK — run, chat with, validate, scaffold, and serve agents."""
    setup_logging()
...
from philharmonica.adk.cli.chat import chat
from philharmonica.adk.cli.deploy import deploy
from philharmonica.adk.cli.new import new
from philharmonica.adk.cli.run import run
from philharmonica.adk.cli.schema import schema
from philharmonica.adk.cli.serve import serve
from philharmonica.adk.cli.sessions import sessions
from philharmonica.adk.cli.validate import validate
