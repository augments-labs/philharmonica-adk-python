...
Cross-references:
* ``philharmonica.adk.sandbox.capabilities.memory.MemoryCapability`` — the
  capability surface that wires generation into the agent loop.
"""

from __future__ import annotations

from philharmonica.adk.sandbox.memory.consolidation import run_consolidation
...
from philharmonica.adk.sandbox.memory.manager import SandboxMemoryManager
...
from philharmonica.adk.sandbox.memory.rollout_extraction import run_rollout_extraction
from philharmonica.adk.sandbox.memory.rollouts import (
    build_rollout_payload,
    dump_rollout_json,
    terminal_metadata_for_exception,
    terminal_metadata_for_result,
)
from philharmonica.adk.sandbox.memory.storage import (
